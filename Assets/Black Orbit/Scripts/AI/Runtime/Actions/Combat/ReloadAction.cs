...
namespace Black_Orbit.Scripts.AI.Runtime.Actions.Combat
{
    public class ReloadAction : AIAction
    {
        ...
        public ReloadAction(AICombat combat, float baseWeight = 0.9f, int lowThreshold = 5, int highThreshold = 20)
        ...
        {
            yield return new AmmoLow(_lowThreshold, _highThreshold);
        }
